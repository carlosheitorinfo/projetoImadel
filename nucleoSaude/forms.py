...
class CadastroPacientesModelForm(forms.ModelForm):
    ...
    class Meta:
        model = Pacientes
        fields = ['nome_paciente', 'prontuario', 'data_nascimento', 'telefone', 'endereco', 'email']
        widgets = {
            'nome_paciente': forms.TextInput(attrs={'placeholder': 'nome_paciente', 'class': 'form-control'}),
            'prontuario': forms.TextInput(attrs={'placeholder': 'prontuario', 'class': 'form-control'}),
...
class AgendamentoModelForm(forms.ModelForm):
    ...
    class Meta:
        model = Agendamento
        fields = ['nome_paciente', 'prontuario', 'data_consulta', 'nome_medico']
        widgets = {
            'nome_paciente': forms.TextInput(attrs={'placeholder': 'nome_paciente', 'class': 'form-control'}),
            'prontuario': forms.TextInput(attrs={'placeholder': 'prontuario', 'class': 'form-control'}),
